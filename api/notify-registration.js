...
export default async function handler(req, res) {
  ...
  // 1. Configuración para SMTP de Gmail con tu contraseña integrada
              ...
              <tr>
                <td style="padding: 40px 32px;">
                  ...
                  <p style="color: #334155; font-size: 13px; line-height: 1.6; margin: 0;">
                    Este registro se encuentra en la infraestructura. Por favor, confirme la validez y comparta estas credenciales con el usuario.
                  </p>
                </td>
              </tr>
            </table>
  ...
  const mailOptions = {
    ...
    subject: `[ALTA DE USUARIO] Solicitud de Acceso - ${razonSocial || name}`,
    html: emailHtml
  };
  ...
  try {
    ...
    return res.status(500).json({ error: 'Falla en el envío: ' + error.message });
  }
}