    ...
    <div className="max-w-4xl mx-auto p-4 space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 md:p-8 rounded-xl border border-slate-200 shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-900 tracking-tight">Panel de Solicitudes</h2>
            <p className="text-sm text-slate-500 mt-0.5">Bandeja de entrada y asignación de soporte</p>
          </div>
        </div>
      ...
      <div className="space-y-4">
        {loading ? (
          ...
          <div className="bg-white p-12 rounded-xl border border-slate-200 text-center shadow-sm space-y-3">
            ...
            <p className="text-sm text-slate-400">No hay solicitudes de servicio registradas en el sistema.</p>
          </div>
        ) : (
          requests.map((ticket) => (
